...
namespace SportCenterAPI.Migrations
{
    ...
    [Migration("20190121142919_UserMemberNonRelation")]
    partial class UserMemberNonRelation
    {
            ...
            modelBuilder.Entity("SportCenterAPI.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourtForeignKey = 2,
                            CreatedDate = new DateTime(2019, 1, 21, 15, 29, 18, 953, DateTimeKind.Local).AddTicks(2469),
                            MemberForeignKey = 2
                        },
                        new
                        {
                            ...
                            CourtForeignKey = 3,
                            CreatedDate = new DateTime(2019, 1, 21, 15, 29, 18, 955, DateTimeKind.Local).AddTicks(6981),
                            MemberForeignKey = 3
                        });
                });
